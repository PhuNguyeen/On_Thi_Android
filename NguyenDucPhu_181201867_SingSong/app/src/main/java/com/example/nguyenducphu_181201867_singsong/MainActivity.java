...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (db.GetData("SELECT * FROM " + db.TABLENAME).getCount() == 0) {
            db.Insert(new Contact_181201867(1, "Phút Cuối", "Bằng Kiều", 3.27));
            db.Insert(new Contact_181201867(2, "Bông Hồng Thủy Tinh", "Bức Tường", 4.18));
            db.Insert(new Contact_181201867(3, "Hà Nội Mùa Thu", "Mỹ Linh", 4.11));
            db.Insert(new Contact_181201867(4, "Bà Tôi", "Tùng Dương", 3.51));
            db.Insert(new Contact_181201867(5, "Đêm Đông", "Bằng Kiều", 4.12));
        ...
        Collections.sort(arrayListObject, (t1, t2) -> t2.getTenBàiHat().compareTo(t1.getTenBàiHat()));
        // set Adapter
