...
public class Phu_Sqlite extends SQLiteOpenHelper {
    ...
    public static final String COL_1 = "TenBaiHat";
    public static final String COL_2 = "CaSi";
    public static final String COL_3 = "ThoiLuong";
    ...
    public void Insert(Contact_181201867 object) {
        ...
        mSqLiteStatement.bindString(1, object.getTenBàiHat());
        mSqLiteStatement.bindString(2, object.getCaSi());
        mSqLiteStatement.bindDouble(3, object.getThoiLuong());
