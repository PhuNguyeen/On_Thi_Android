...
public class HoTenSV_SqLite extends SQLiteOpenHelper {
    public static final String TABLENAME = "Contact_TenSV";
    private static final String DATABASENAME = "HoTenSV.sqlite";
    private static final int VERSION = 1;
    public static final String COL_0 = "Id";
    public static final String COL_1 = "HoTen";
    public static final String COL_2 = "SDT";

    public HoTenSV_SqLite(Context context) {
    ...
    public void Delete(Contact_TenSV object) {
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
        sqLiteDatabase.execSQL("DELETE FROM " + TABLENAME + " WHERE " + COL_0 + " = " + object.getId() + ";");
    }

    public void Insert(Contact_TenSV object) {
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
    ...
    public void Update(Contact_TenSV object) {
        SQLiteDatabase sqLiteDatabase = getWritableDatabase();
