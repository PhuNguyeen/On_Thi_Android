...
public class Phu_Adapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (object != null) {
            ...
            // Xử lý dữ liệu
            textView1.setText(object.getTenBàiHat());
            textView2.setText(object.getCaSi());
            textView3.setText(String.valueOf(object.getThoiLuong()));
        }
        return view;
    }
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint != null && constraint.length() > 0) {
                ...
                for (int i = 0; i < filterList.size(); i++) {
                    ...
                    if (filterList.get(i).getCaSi().toUpperCase().contains(constraint)|| filterList.get(i).getTenBàiHat().toUpperCase().contains(constraint)) {
                        // chú ý -----------------------------------------
                        Contact_181201867 object = new Contact_181201867(filterList.get(i).getId(), filterList.get(i).getTenBàiHat(), filterList.get(i).getCaSi(), filterList.get(i).getThoiLuong());
                        //
