...
public class Phu_Sqlite extends SQLiteOpenHelper {
    ...
    public static final String COL_1 = "TenThietBi";
    public static final String COL_2 = "MoTa";
    ...
    public void Insert(Contact_181201867 object) {
        ...
        mSqLiteStatement.bindString(2, object.getPhoneNumber());
        mSqLiteStatement.bindString(3, String.valueOf(object.isStatus()));
